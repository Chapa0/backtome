...
class LostObjectDetailPageAdmin extends StatefulWidget {
  ...
  @override
  _LostObjectDetailPageAdminState createState() =>
      _LostObjectDetailPageAdminState();
}
...
class _LostObjectDetailPageAdminState extends State<LostObjectDetailPageAdmin> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            if (widget.lostObject.rechazado == true)
              Padding(
            ...
            if (widget.lostObject.aprobado == false ||
                widget.lostObject.aprobado == null)
              Padding(
                padding:
                        ...
                        Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              right: 15,
                              child: Container(
                                // ajustar el tamaño del contenedor según sea necesario
                                width: 40,
                                height: 40,
                                decoration: BoxDecoration(
                                  ...
                                  color: Colors.red.withOpacity(
                                      0.7), // Fondo rojo con transparencia
                                  shape: BoxShape
  ...
  Widget _buildClaimantList() {
    ...
    if (widget.lostObject.estadoReclamacion == 'Entregado') {
      ...
      Reclamacion? reclamacionEntregada = widget.lostObject.reclamaciones
          .firstWhere(
            ...
            Card(
              ...
              child: ListTile(
                leading: CircleAvatar(
                  backgroundImage: (reclamacionEntregada
                              .fotoReclamante.isNotEmpty
                          ? NetworkImage(reclamacionEntregada.fotoReclamante)
                          : const AssetImage('assets/default_avatar.png'))
                      as ImageProvider,
                ),
                title: Text(
                    '${reclamacionEntregada.nombreReclamante} ${reclamacionEntregada.apellidoReclamante}'),
                subtitle:
                    Text('Este es el usuario al que se le entregó el objeto.'),
                onTap: () {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                    'Fecha de reclamación: ${_formatDateTime(reclamacion.horaReclamacion)}'),
                SizedBox(height: 8),
                Text('Descripción:'),
  ...
  void _deliverObjectToClaimant(Reclamacion reclamacion) async {
    ...
    bool confirm = await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            '¿Estás seguro de que deseas entregar el objeto a ${reclamacion.nombreReclamante}?'),
        actions: [
          TextButton(
